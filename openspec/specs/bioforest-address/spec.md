# bioforest-address Specification

## Purpose
Define Bioforest address derivation and validation rules for KeyApp, aligned with mpay/walletapi production defaults while allowing dev/test environments via chain-config.
## Requirements
