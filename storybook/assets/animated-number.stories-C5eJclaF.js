...
}`,...d.parameters?.docs?.source},description:{story:"Interactive demo showing the animation in action",...d.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...i.parameters?.docs?.source},description:{story:"Simulates loading data from an API",...i.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...u.parameters?.docs?.source},description:{story:"Different decimal configurations",...u.parameters?.docs?.description}}};const k=["Default","Loading","SmallNumber","LargeNumber","WholeNumber","Interactive","LoadingToLoaded","WithStringValue","MultipleNumbers","DecimalVariants"];export{u as DecimalVariants,v as Default,d as Interactive,b as LargeNumber,x as Loading,i as LoadingToLoaded,m as MultipleNumbers,g as SmallNumber,h as WholeNumber,c as WithStringValue,k as __namedExportsOrder,V as default};
