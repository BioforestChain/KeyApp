...
}`,...c.parameters?.docs?.source},description:{story:"Splash 路径：icon -> splash(icon+bg) -> window",...c.parameters?.docs?.description}}};const V=["DirectPath","SplashPath"];export{r as DirectPath,c as SplashPath,V as __namedExportsOrder,G as default};
