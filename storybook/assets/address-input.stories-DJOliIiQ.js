...
}`,...c.parameters?.docs?.source},description:{story:"已知联系人显示模式 - 显示头像和双行信息（名称+地址）",...c.parameters?.docs?.description}}};const P=["Default","WithValue","WithValueFocused","LongAddressUnfocused","WithError","Controlled","DifferentChains","WithoutScan","TransferForm","WithContactSuggestions","FilterByChain","UnknownAddressDisplay","KnownContactDisplay"];export{b as Controlled,l as Default,f as DifferentChains,o as FilterByChain,c as KnownContactDisplay,p as LongAddressUnfocused,g as TransferForm,n as UnknownAddressDisplay,d as WithContactSuggestions,m as WithError,i as WithValue,u as WithValueFocused,x as WithoutScan,P as __namedExportsOrder,O as default};
