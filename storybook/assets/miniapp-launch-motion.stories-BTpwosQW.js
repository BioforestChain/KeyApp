...
}`,...c.parameters?.docs?.source},description:{story:"Splash 路径：icon -> splash(icon+bg) -> window",...c.parameters?.docs?.description}}};const G=["DirectPath","SplashPath"];export{r as DirectPath,c as SplashPath,G as __namedExportsOrder,z as default};
