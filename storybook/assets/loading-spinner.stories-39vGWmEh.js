import{j as e}from"./iframe-Cdc63axx.js";import{L as s}from"./loading-spinner-BUGHRkCk.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CDN07tui.js";import"./useTranslation-B1THGpvK.js";import"./index-CgApz5ds.js";const d={title:"Common/LoadingSpinner",component:s,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"]},fullScreen:{control:"boolean"}}},r={},n={render:()=>e.jsxs("div",{className:"flex items-center gap-8",children:[e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(s,{size:"sm"}),e.jsx("span",{className:"text-muted-foreground text-xs",children:"Small"})]}),e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(s,{size:"md"}),e.jsx("span",{className:"text-muted-foreground text-xs",children:"Medium"})]}),e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(s,{size:"lg"}),e.jsx("span",{className:"text-muted-foreground text-xs",children:"Large"})]})]})},a={render:()=>e.jsxs("button",{className:"bg-primary text-primary-foreground inline-flex items-center gap-2 rounded-md px-4 py-2",children:[e.jsx(s,{size:"sm",className:"text-white"}),e.jsx("span",{children:"加载中..."})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
