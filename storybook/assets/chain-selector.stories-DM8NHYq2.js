...
}`,...S.parameters?.docs?.source},description:{story:"组批量选择测试",...S.parameters?.docs?.description}}};const R=["Default","Interactive","DefaultSelectionBioforest","SearchFilter","EmptyChains","NoSearch","AllSelected","WithFavorites","ThemeDark","GroupSelection"];export{g as AllSelected,C as Default,h as DefaultSelectionBioforest,u as EmptyChains,S as GroupSelection,l as Interactive,p as NoSearch,m as SearchFilter,v as ThemeDark,f as WithFavorites,R as __namedExportsOrder,O as default};
