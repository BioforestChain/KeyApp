import{j as e}from"./iframe-Dcmh7lQ9.js";import{P as c}from"./page-header-Cq4Fwyjg.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-4perknFd.js";import"./useTranslation-CXs6ROZL.js";import"./index-BzYTzJ7n.js";const g={title:"Layout/PageHeader",component:c,tags:["autodocs"],decorators:[n=>e.jsxs("div",{className:"bg-background min-h-[200px]",children:[e.jsx(n,{}),e.jsx("div",{className:"p-4",children:e.jsx("p",{className:"text-muted-foreground",children:"页面内容区域"})})]})]},r={args:{title:"转账",onBack:()=>alert("返回")}},t={args:{title:"设置",onBack:()=>alert("返回"),rightAction:e.jsx("button",{className:"text-primary text-sm font-medium",children:"保存"})}},s={args:{title:"钱包详情",onBack:()=>alert("返回"),transparent:!0},decorators:[n=>e.jsxs("div",{className:"bg-gradient-purple min-h-[200px]",children:[e.jsx(n,{}),e.jsx("div",{className:"p-4 text-white",children:e.jsx("p",{children:"渐变背景内容"})})]})]},a={args:{title:"首页",rightAction:e.jsx("button",{className:"hover:bg-muted/50 flex h-8 w-8 items-center justify-center rounded-full",children:e.jsx("svg",{className:"h-5 w-5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"})})})}},o={args:{onBack:()=>alert("返回"),children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-sm",children:"ETH"}),e.jsx("svg",{className:"h-4 w-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M19 9l-7 7-7-7"})})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    title: '转账',
    onBack: () => alert('返回')
  }
