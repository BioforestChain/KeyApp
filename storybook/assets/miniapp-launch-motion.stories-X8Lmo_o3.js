...
}`,...c.parameters?.docs?.source},description:{story:"Splash 路径：icon -> splash(icon+bg) -> window",...c.parameters?.docs?.description}}};const D=["DirectPath","SplashPath"];export{r as DirectPath,c as SplashPath,D as __namedExportsOrder,A as default};
