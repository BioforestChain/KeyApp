...
<div class="download-grid">
  <div class="download-card">
    ...
    <p>经过充分测试的稳定版本，推荐日常使用。</p>
    <DwebInstallLink path="./dweb/metadata.json" class="download-btn">安装到 DWEB</DwebInstallLink>
    <a href="./dweb/bfmpay-dweb.zip" class="download-link">下载 ZIP 文件</a>
  </div>
  ...
  <div class="download-card">
    ...
    <p>包含最新功能，每次代码更新自动发布。</p>
    <DwebInstallLink path="./dweb-dev/metadata.json" class="download-btn secondary">安装 Beta 版</DwebInstallLink>
    <a href="./dweb-dev/bfmpay-dweb-beta.zip" class="download-link">下载 ZIP 文件</a>
  </div>
</div>
