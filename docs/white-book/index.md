...
| 章节 | 内容 |
|-----|------|
| [离线能力](./10-离线能力篇/) | 离线检测、缓存策略、离线签名、数据同步 |
...
| 章节 | 内容 |
|-----|------|
| [错误处理](./11-错误处理篇/) | 错误码目录、恢复策略、UI 规范、日志上报 |
...
| 章节 | 内容 |
|-----|------|
| [性能预算](./12-性能预算篇/) | 加载指标、操作预算、包体积、内存限制 |
...
| 章节 | 内容 |
|-----|------|
| [监控告警](./14-监控告警篇/) | 埋点规范、性能监控、错误上报、告警规则 |
