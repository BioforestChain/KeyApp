...
| [03 导航系统](./03-架构篇/03-导航系统/) | Stackflow 配置、路由设计、Activity |
| [04 状态管理](./03-架构篇/04-状态管理/) | TanStack Store、Query、持久化 |
...
| [02 链服务接口](./04-服务篇/02-链服务接口/) | IAssetService、ITransactionService 等 |
...
| 章节 | 内容 |
|-----|------|
| [01 组件体系](./05-组件篇/01-组件体系/) | shadcn/ui、组件分类、设计规范 |
| [02 表单系统](./05-组件篇/02-表单系统/) | TanStack Form、验证、错误处理 |
| [03 组件开发规范](./05-组件篇/03-组件开发规范/) | Storybook、测试、文档 |
...
| [02 身份认证](./06-安全篇/02-身份认证/) | 密码锁、指纹支付、应用锁 |
