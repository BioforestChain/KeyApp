...
import { TxStatusDisplay } from '@/components/transaction/tx-status-display';
...
export const WalletLockStep: StoryObj = {
  render: () => {
    ...
    return (
      <div className="bg-background w-[375px] rounded-2xl shadow-xl">
        ...
        <div className="px-4 pb-4">
          ...
          />
          {error && (
            <div className="text-destructive mt-3 flex items-center justify-center gap-1.5 text-sm">
          ...
          <button
            type="button"
            className="text-muted-foreground hover:text-foreground mt-4 w-full py-2 text-center text-sm"
          >
            取消
          </button>
        </div>
...
export const ConfirmedState: StoryObj = {
  render: () => {
    ...
    return (
      <div className="bg-background w-93.75 rounded-2xl shadow-xl">
        <div className="flex justify-center py-3">
          <div className="bg-muted h-1 w-10 rounded-full" />
        </div>
        <TxStatusDisplay
          ...
          return (
            <div className="p-4">
              ...
              <button
                ...
                className="text-primary mt-4 w-full py-2 text-center text-sm"
              >
                模拟需要安全密码 →
              </button>
            </div>
          ...
          return (
            <div className="space-y-4 p-4">
              ...
              <button
                ...
                className="bg-primary text-primary-foreground w-full rounded-full py-3 font-medium"
              >
                确认
              </button>
            </div>
            ...
            <>
              ...
              <div className="space-y-2 px-4 pb-4">
                <button
                  type="button"
                  onClick={() => setStep('broadcasting')}
                  className="bg-primary text-primary-foreground flex w-full items-center justify-center gap-2 rounded-full py-3 font-medium"
                >
                  <IconRefresh className="size-4" />
                  重试
                </button>
