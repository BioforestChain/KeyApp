 ...
 */
function MarqueeText({ children, copyable = false, duration, onCopy, className, ...props }: MarqueeTextProps) {
  ...
  return (
    ...
    >
      <span
        ref={textRef}
        className={cn('whitespace-nowrap', isOverflowing && 'animate-marquee', isPaused && 'animate-paused')}
        style={isOverflowing ? ({ '--marquee-duration': `${animationDuration}s` } as React.CSSProperties) : undefined}
      >
        {children}
      </span>
