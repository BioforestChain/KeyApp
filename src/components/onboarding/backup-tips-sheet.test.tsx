...
describe('BackupTipsSheet', () => {
  ...
  it('renders when open', () => {
    renderWithProviders(<BackupTipsSheet {...defaultProps} />)
    expect(screen.getByText('备份助记词')).toBeInTheDocument()
  })

  it('does not render content when closed', () => {
    renderWithProviders(<BackupTipsSheet {...defaultProps} open={false} />)
  ...
  it('applies custom className', () => {
    renderWithProviders(<BackupTipsSheet {...defaultProps} className="custom-class" />)
