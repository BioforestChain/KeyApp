...
export function ImportWalletSuccess({
  ...
  return (
    <div data-testid="import-success-step" className={cn('flex min-h-screen flex-col items-center justify-center px-6 py-8', className)}>
      {/* Success icon */}
      ...
      {/* Success message */}
      <h1 data-testid="success-message" className="mb-2 text-2xl font-bold">{t('import.success.title')}</h1>
      ...
      <div className="w-full max-w-xs">
        <button
          type="button"
          data-testid="enter-wallet-button"
