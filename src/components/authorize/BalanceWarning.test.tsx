...
describe('BalanceWarning', () => {
  it('renders insufficient balance message', () => {
    renderWithI18n(<BalanceWarning balance="1.0" required="1.502" symbol="ETH" />);
  ...
  it('applies custom className', () => {
    const { container } = renderWithI18n(
      <BalanceWarning balance="1.0" required="1.502" symbol="ETH" className="custom-class" />,
    );
  ...
  it('displays warning icon', () => {
    const { container } = renderWithI18n(<BalanceWarning balance="1.0" required="1.502" symbol="ETH" />);
  ...
  it('renders with different token symbols', () => {
    renderWithI18n(<BalanceWarning balance="0.05" required="0.1" symbol="BTC" />);
  ...
  it('handles large numbers', () => {
    renderWithI18n(<BalanceWarning balance="1000000" required="2000000" symbol="USDT" />);
