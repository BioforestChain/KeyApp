  ...
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        />
        <p className="text-sm text-muted">当前强度: {strength}</p>
      </div>
    )
  },
}
...
export const WithLabel: Story = {
  render: () => (
    <div className="space-y-2">
      ...
      <p className="text-xs text-muted">密码用于加密您的钱包，请牢记</p>
    </div>
  ),
}
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {isMatch && (
            <p className="text-xs text-secondary">密码匹配</p>
          )}
        </div>
      </div>
    )
...
export const StrengthLevels: Story = {
  render: () => (
    <div className="space-y-6">
      <div>
        <p className="text-sm mb-2">弱密码 (123456)</p>
        <PasswordInput value="123456" showStrength readOnly />
      </div>
      <div>
        <p className="text-sm mb-2">中等密码 (Password1)</p>
        <PasswordInput value="Password1" showStrength readOnly />
      </div>
      <div>
        <p className="text-sm mb-2">强密码 (MyP@ssw0rd!)</p>
