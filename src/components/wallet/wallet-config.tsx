  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="flex justify-center px-4">
        <div className="w-full max-w-[360px] aspect-[1.6/1]">
          <WalletCard
      ...
      {isEditMode ? (
        <>
          ...
          <div className="space-y-2">
            <label className="text-sm text-muted-foreground">{t('onboarding:theme.walletName')}</label>
            <Input
              value={editName}
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-mono text-muted-foreground">{editThemeHue.toFixed(1)}°</span>
              </div>
              <div
                ref={sliderRef}
                className="relative h-8 cursor-pointer rounded-full touch-none"
                style={{
                  background: 'linear-gradient(to right, oklch(0.6 0.25 0), oklch(0.6 0.25 60), oklch(0.6 0.25 120), oklch(0.6 0.25 180), oklch(0.6 0.25 240), oklch(0.6 0.25 300), oklch(0.6 0.25 360))',
                }}
