  ...
  if (!copyable) {
    return (
      ...
      >
        ...
        {/* 绝对定位的实际内容 */}
        <span className={cn('absolute inset-0 truncate', !isReady && 'invisible')}>
          {displayText}
        </span>
      </span>
    )
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded',
        className
      )}
      title={address}
