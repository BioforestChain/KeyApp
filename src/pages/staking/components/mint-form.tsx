...
export function MintForm({ onSuccess, className }: MintFormProps) {
  ...
  const handleTokenSelect = useCallback(
    (token: { asset: string; targetChain: string; targetAsset: string }) => {
    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className="rounded-xl bg-muted/50 p-4">
        ...
        <div className="flex items-center justify-between rounded-lg bg-background px-3 py-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {CHAIN_NAMES[targetChain] || t('selectToken')}
            </span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="mt-3 flex items-center justify-between text-sm">
          ...
          <span className="font-semibold">{amount || '0.00'} {targetAsset}</span>
        </div>
      </div>
