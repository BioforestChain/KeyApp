            ...
            <AnimatePresence mode="popLayout">
              {state === 'idle' && (
                ...
                >
                  ...
                  >
                    <motion.span layoutId="miniapp-symbol" className="select-none text-2xl">🚀</motion.span>
                  </motion.div>
                </motion.div>
              )}
            </AnimatePresence>
                ...
                >
                  <div className="flex items-center gap-3 bg-blue-500/80 p-4">
                    <motion.div
                      ...
                      style={{ borderRadius: 16 }}
                    >
                      <motion.span layoutId="miniapp-symbol" className="select-none text-3xl">🚀</motion.span>
                    </motion.div>
              ...
              {state === 'idle' && (
                ...
                >
                  <motion.div
                    ...
                    style={{ borderRadius: 16 }}
                  >
                    <motion.span layoutId="splash-symbol" className="select-none text-2xl">🎯</motion.span>
                  </motion.div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence mode="popLayout">
              {state === 'splash' && (
                ...
                >
                  ...
                  >
                    <motion.span layoutId="splash-symbol" className="select-none text-4xl">🎯</motion.span>
                  </motion.div>
                </motion.div>
              )}
            </AnimatePresence>
              ...
              {state === 'window' && (
                ...
                >
                  <div className="flex items-center gap-3 bg-orange-500 p-4">
                    ...
                    >
                      <motion.span layoutId="splash-symbol" className="select-none text-lg">🎯</motion.span>
                    </motion.div>
