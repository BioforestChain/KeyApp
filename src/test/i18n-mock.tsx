...
import zhCNEcosystem from '@/i18n/locales/zh-CN/ecosystem.json'
...
testI18n.use(initReactI18next).init({
  lng: 'zh-CN',
  fallbackLng: 'zh-CN',
  ns: ['translation', 'authorize', 'common', 'settings', 'onboarding', 'transaction', 'notification', 'wallet', 'security', 'ecosystem'],
